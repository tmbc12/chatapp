  ...
  return (
    <main className='relative flex flex-col h-screen p-1 overflow-hidden bg-neutral'>
      ...
      <section className=' mt-10 flex flex-col flex-grow w-full px-4 overflow-y-scroll sm:px-10 md:px-32  '>
        {messages.length ? (
          ...
          <div className='flex my-2'>
            <div className='w-screen overflow-hidden cursor-pointer flex items-center justify-center'>
              <ul className='grid grid-cols-2 gap-8 mx-10 w-fit'>
      ...
      <form
        ...
        <div className='flex items-stretch justify-between w-full cursor-pointer pb-5'>
          <textarea
            ref={inputRef}
